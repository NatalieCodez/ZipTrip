...
const s = StyleSheet.create({
  ...
  tagline:          { fontSize: 15, color: 'rgba(255,255,255,0.55)', textAlign: 'center', lineHeight: 22, marginTop: 28, fontWeight: '400' },
  ...
  btnPrimary:       { width: '100%', height: 54, borderRadius: 14, backgroundColor: '#A89968', alignItems: 'center', justifyContent: 'center', shadowColor: '#A89968', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.3, shadowRadius: 10, elevation: 6 },
